...
TRIGGER_CHAINS = {
        ...
        'steps': [
            {
                'delay_hours': 3,
                'message': (
                    "🌱 Пришлите мне фото любого растения — расскажу, "
            ...
            },
            {
                'delay_hours': 24,
                'message': (
                    "🌿 Вот что вы получите, когда пришлёте фото растения:\n\n"
                    "🔍 Вид и состояние\n"
                    "💧 График полива\n"
                    "🔔 Напоминания\n\n"
            ...
            },
            {
                ...
                'message': (
                    ...
                    "Пришлите фото, когда будет настроение!"
                ),
                'button_text': '📸 Отправить фото',
                'button_callback': 'onboarding_analyze',
            },
        ...
        'steps': [
            {
                'delay_hours': 3,
                'message': (
                    "🌱 Кстати, я всё ещё жду фото вашего растения!\n\n"
                    "Просто сфотографируйте растение — и пришлите мне. "
            ...
            },
            {
                'delay_hours': 24,
                'message': (
                    "🤔 Не знаете, с чего начать? Вот что вы получите, "
                    "когда добавите растение:\n\n"
                    "🔍 Узнаете точный вид и состояние\n"
                    "💧 Получите персональный график полива\n"
                    "🔔 Я буду напоминать, когда пора поливать\n\n"
                    "Достаточно одного фото — попробуйте!"
                ),
            ...
            },
            {
                ...
                'message': (
                    ...
                    "если растение болеет, получите одни советы, "
                    "если цветёт — совсем другие.\n\n"
                    "Пришлите фото, когда будет настроение — "
                    "посмотрим, что у вас растёт!"
                ),
                'button_text': None,
    ...
    'first_plant_discount': {
        'description': 'Предложение подписки через 15 мин после первого растения (если не задал вопрос)',
        'steps': [
            {
    ...
    'new_user_discount': {
        'description': 'Follow-up подписки: напоминания через 24ч и 60ч',
        'steps': [
            {
                # Шаг 1 (через 24ч после первого предложения подписки)
                'delay_hours': 24,
                'message': (
                    "⏰ Напоминаю про подписку!\n\n"
            ...
            },
            {
                ...
                'delay_hours': 60,
                'message': (
                    "🌟 Один платёж — и никаких лимитов!\n\n"
                    "Доступ навсегда за 1999₽: платите один раз, "
                    "пользуетесь без ограничений всегда.\n\n"
                    "Или попробуйте месяц за 299₽."
                ),
                'button_text': '⭐ Оформить подписку',
                'button_callback': 'subscribe_pro',
            },
    ...
    'promo_not_paid': {
        'description': 'Напоминание: ввёл промокод, но не оплатил',
        'steps': [
            {
                'delay_hours': 24,
                'message': (
                    "🎁 Ваш промокод ещё действует!\n\n"
                    "Вы ввели промокод, но не оформили подписку. "
                    "Скидка применится автоматически — просто выберите тариф."
                ),
                'button_text': '⭐ Выбрать тариф',
                'button_callback': 'subscribe_pro',
            },
